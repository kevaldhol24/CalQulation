        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section className="mb-16">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-gray-800/50 dark:to-red-900/30 p-6 rounded-xl shadow-sm">
              <p className="text-gray-700 dark:text-gray-200 leading-relaxed">
                A Systematic Withdrawal Plan (SWP) is an investment strategy that allows you to withdraw a fixed 
                amount from your investment portfolio at regular intervals, typically monthly. It&apos;s the opposite 
                of a SIP (Systematic Investment Plan) and is commonly used for retirement planning or generating 
                regular income from investments. Our SWP calculator helps you determine how long your investments 
                will last based on your withdrawal amount, expected returns, and initial investment.
              </p>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <p className="text-gray-700 dark:text-gray-200 leading-relaxed mb-10">
              Our comprehensive SWP calculator uses advanced financial calculations to project your withdrawal plan. 
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300">
                        Test different monthly withdrawal amounts to find the right balance 
                        between income and portfolio longevity.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300">
                        See how different market conditions and return expectations 
                        affect your withdrawal sustainability.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 dark:text-gray-300">
                        Visualize how your initial investment is distributed between 
                        withdrawals, interest earned, and remaining balance.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Perfect for planning your retirement income. Calculate how much you can safely 
                  withdraw each month without depleting your savings too quickly.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  SWP can be more tax-efficient than lumpsum withdrawals, especially for 
                  equity mutual funds where gains are taxed based on holding period.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Test multiple scenarios with different withdrawal amounts and return rates 
                  to find the optimal strategy for your financial situation.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Your remaining investment continues to grow, providing some protection 
                  against inflation while you make regular withdrawals.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-orange-100 dark:border-gray-700">
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                Our SWP calculator uses compound interest calculations to determine how your investment 
                balance changes over time with regular withdrawals:
              </p>
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4 font-medium">This calculation is repeated monthly until:</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                  <span className="text-xl font-bold text-orange-600 dark:text-orange-400">Balance = 0</span>
                  <p className="text-gray-700 dark:text-gray-300">
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                  <span className="text-xl font-bold text-red-600 dark:text-red-400">Time Period</span>
                  <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      A common rule of thumb is the 4% rule - withdrawing no more than 4% of your 
                      portfolio annually. This helps ensure your money lasts for 25-30 years.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Maintain a diversified portfolio across equity, debt, and other assets 
                      to reduce volatility and ensure steady returns during your withdrawal phase.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Keep 6-12 months of expenses in liquid investments separate from your 
                      SWP corpus to handle emergencies without disrupting your withdrawal plan.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Review your SWP annually and adjust withdrawal amounts based on portfolio 
                      performance, inflation, and changing financial needs.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                <div className="p-6">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    SWP gives you control over the withdrawal amount and timing, while dividend 
                    payouts depend on fund performance and management decisions. SWP provides 
                    predictable cash flow, making it better for financial planning, whereas 
                    dividends can be irregular and uncertain.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                <div className="p-6">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    Yes, most mutual fund companies allow you to modify or stop your SWP. 
                    You can increase, decrease, or pause withdrawals based on your changing 
                    financial needs. Some funds may have restrictions on frequency of changes.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                <div className="p-6">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    If your portfolio value drops due to market conditions, your SWP will 
                    continue as scheduled, but this will reduce the longevity of your investment. 
                    Consider reducing withdrawal amounts during market downturns to preserve capital.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                <div className="p-6">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    SWP withdrawals are treated as redemptions and taxed based on holding period. 
                    For equity funds, gains are tax-free if held for more than 1 year, and 15% 
                    if held for less. For debt funds, gains are taxed at your income tax slab. 
          ...
          <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
            <p className="text-sm text-gray-600 dark:text-gray-400 italic">
              Note: This SWP calculator provides estimates based on the information you provide. 
              Actual investment returns may vary based on market conditions, fund performance, and economic factors. 
              The calculations assume consistent market returns and do not account for market volatility, 
